...
import (
	...
	appspub "github.com/GreptimeTeam/greptimedb-operator/third_party/kruise/apis/apps/pub"
	...
	imagejobutilfunc "github.com/GreptimeTeam/greptimedb-operator/third_party/kruise/pkg/util/imagejob/utilfunction"
	...
	"github.com/GreptimeTeam/greptimedb-operator/third_party/kruise/pkg/util/specifieddelete"
)
...
func (ssc *defaultStatefulSetControl) refreshPodState(set *appsv1beta1.StatefulSet, pod *v1.Pod, updateRevision string) (bool, time.Duration, error) {
	...
	case appspub.LifecycleStatePreparingUpdate:
		...
		// so just update pod lifecycle state. ref: https://github.com/GreptimeTeam/greptimedb-operator/third_party/kruise/issues/1156
